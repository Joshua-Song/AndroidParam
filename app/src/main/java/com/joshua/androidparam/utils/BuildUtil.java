...
public class BuildUtil {
    ...
    public static String getRelease2() {
        return YSystemPropertiesUtil.get("ro.build.version.release");
    }

    public static String getRelease3() {
        return YSystemPropertiesUtil.get("ro.build.version.release", null);
    }
    /**
     *
     * @return
    ...
    public static String getBrand2() {
        return YSystemPropertiesUtil.get("ro.product.brand");
    }
    /**
     *
     * @return
    ...
    public static String getModel2() {
        return YSystemPropertiesUtil.get("ro.product.model");
    }
    /**
     *
     * @return
    ...
    public static String getBoard2() {
        return YSystemPropertiesUtil.get("ro.product.board");
    }
    ...
    public static String getProduct2() {
        return YSystemPropertiesUtil.get("ro.product.name");
    }
    ...
    public static String getCpuAbi_2() {
        return YSystemPropertiesUtil.get("ro.product.cpu.abi");
    }
    ...
    public static String getCpuAbi2_2() {
        return YSystemPropertiesUtil.get("ro.product.cpu.abi2");
    }
    ...
    public static String[] getSupported_abis2() {
        return YSystemPropertiesUtil.getStringList("ro.product.cpu.abilist", ",");
    }
    ...
    public static String[] getSupported_32_bit_abis2() {
        return YSystemPropertiesUtil.getStringList("ro.product.cpu.abilist32", ",");
    }
    ...
    public static String getID2() {
        return YSystemPropertiesUtil.get("ro.build.id");
    }
    /**
     *
     * @return
    ...
    public static String getDisplay2() {
        return YSystemPropertiesUtil.get("ro.build.display.id");
    }
    ...
    public static String getFingerprint3() {
        return YSystemPropertiesUtil.get("ro.build.fingerprint");
    }
    ...
    public static String getManufacturer2() {
        return YSystemPropertiesUtil.get("ro.product.manufacturer");
    }
    /**
     *
     * @return HOST/
    ...
    public static String getHost2() {
        return YSystemPropertiesUtil.get("ro.build.host");
    }
    ...
    public static String getType2() {
        return YSystemPropertiesUtil.get("ro.build.type");
    }
    /**
     *
     * @return SDK
    ...
    public static String getSDK2() {
        return YSystemPropertiesUtil.get("ro.build.version.sdk");
    }

    public static String getSDK3() {
        return YSystemPropertiesUtil.get("ro.build.version.sdk", null);
    }
    ...
    public static String getTags2() {
        return YSystemPropertiesUtil.get("ro.build.tags");
    }
    ...
    public static String getDevice2() {
        return YSystemPropertiesUtil.get("ro.product.device");
    }
    ...
    public static String getSerial2() {
        return YSystemPropertiesUtil.get("ro.serialno");
    }
    ...
    public static String getRadioVersion3() {
        return YSystemPropertiesUtil.get("gsm.version.baseband");
    }
    ...
    public static String getHardWare2() {
        return YSystemPropertiesUtil.get("ro.hardware");
    }
    ...
    public static String getUser2() {
        return YSystemPropertiesUtil.get("ro.build.user");
    }
}
